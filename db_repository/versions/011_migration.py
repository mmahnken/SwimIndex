...
pre_meta = MetaData()
post_meta = MetaData()
freestyle_int = Table('freestyle_int', pre_meta,
...
def upgrade(migrate_engine):
    ...
    pre_meta.tables['freestyle_int'].columns['a275'].drop()
    pre_meta.tables['freestyle_int'].columns['a700'].drop()
    pre_meta.tables['freestyle_int'].columns['a900'].drop()
    post_meta.tables['freestyle_int'].columns['a450'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    pre_meta.tables['freestyle_int'].columns['a275'].create()
    pre_meta.tables['freestyle_int'].columns['a700'].create()
    pre_meta.tables['freestyle_int'].columns['a900'].create()
    post_meta.tables['freestyle_int'].columns['a450'].drop()
